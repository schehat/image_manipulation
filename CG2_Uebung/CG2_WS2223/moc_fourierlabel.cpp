...
struct qt_meta_stringdata_FourierLabel_t {
    QByteArrayData data[5];
    char stringdata0[44];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FourierLabel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FourierLabel_t qt_meta_stringdata_FourierLabel = {
    {
QT_MOC_LITERAL(0, 0, 12), // "FourierLabel"
...
QT_MOC_LITERAL(4, 38, 5) // "event"
    ...
    "FourierLabel\0posChanged\0\0QMouseEvent*\0"
    "event"
};
...
void FourierLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (FourierLabel::*)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FourierLabel::posChanged)) {
                *result = 0;
                return;
            }
        }
...
void *FourierLabel::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_FourierLabel.stringdata0))
        return static_cast<void*>(this);
    return QLabel::qt_metacast(_clname);
}

int FourierLabel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void FourierLabel::posChanged(QMouseEvent * _t1)
{
